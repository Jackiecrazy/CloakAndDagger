...
public class SyncTagDataPacket {
    ...
    private static final FriendlyByteBuf.Reader<TagKey<Item>> ritem = f -> ItemTags.create(new ResourceLocation(CloakAndDagger.MODID, f.readResourceLocation().getPath()));;
