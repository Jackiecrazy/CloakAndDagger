...
//    }
    ...
    public static void dodge(DodgeEvent.ServerDodgeEvent e) {
        if (GeneralConfig.elenai && !e.isCanceled()) {
            jackiecrazy.cloakanddagger.event.DodgeEvent v = new jackiecrazy.cloakanddagger.event.DodgeEvent(e.getPlayer(), jackiecrazy.cloakanddagger.event.DodgeEvent.Direction.values()[e.getDirection().ordinal()], e.getForce());
