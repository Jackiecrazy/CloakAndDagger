...
public class ItemTooltipHandler {
    ...
    public static void tooltip(ItemTooltipEvent e) {
        ...
        if (CombatUtils.isWeapon(e.getItemStack())) {
            e.getToolTip().add(Component.translatable("cloak.tooltip.distract", CombatUtils.getDamageMultiplier(Awareness.DISTRACTED, e.getItemStack()) + "x").withStyle(ChatFormatting.GRAY));
            e.getToolTip().add(Component.translatable("cloak.tooltip.unaware", CombatUtils.getDamageMultiplier(Awareness.UNAWARE, e.getItemStack()) + "x").withStyle(ChatFormatting.GRAY));
        }
    }
}
