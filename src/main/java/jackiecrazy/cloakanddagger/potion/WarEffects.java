package jackiecrazy.cloakanddagger.potion;
...
public class WarEffects {
    public static final DeferredRegister<Effect> EFFECTS = DeferredRegister.create(ForgeRegistries.POTIONS, CloakAndDagger.MODID);
