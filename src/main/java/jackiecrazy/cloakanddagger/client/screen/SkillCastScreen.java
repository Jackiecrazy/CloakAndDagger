package jackiecrazy.cloakanddagger.client.screen;
...
import jackiecrazy.cloakanddagger.networking.SelectSkillPacket;
...
public class SkillCastScreen extends Screen {
    private static final ResourceLocation radial = new ResourceLocation(CloakAndDagger.MODID, "textures/skill/radialhud.png");
    private static final ResourceLocation cooldown = new ResourceLocation(CloakAndDagger.MODID, "textures/skill/blank.png");
