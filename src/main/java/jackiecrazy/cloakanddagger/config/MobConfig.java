...
public class MobConfig {
    ...
    private static final String[] SNEAK = {
            "ars_nouveau:ally_vex, ahmvodinp",
            "ars_nouveau:blazing_weald_walker, ahmvodinp",
            "ars_nouveau:carbuncle, ahmvodinp",
            "ars_nouveau:cascading_weald_walker, ahmvodinp",
            "ars_nouveau:drygmy, ahmvodinp",
            "ars_nouveau:familiar_bookwyrm, ahmvodinp",
            "ars_nouveau:familiar_carbuncle, ahmvodinp",
            "ars_nouveau:familiar_drygmy, ahmvodinp",
            "ars_nouveau:familiar_jabberwog, ahmvodinp",
            "ars_nouveau:familiar_sylph, ahmvodinp",
            "ars_nouveau:familiar_wixie, ahmvodinp",
            "ars_nouveau:flourishing_weald_walker, ahmvodinp",
            "ars_nouveau:summon_horse, ahmvodinp",
            "ars_nouveau:summon_wolf, ahmvodinp",
            "ars_nouveau:sylph, ahmvodinp",
            "ars_nouveau:vexing_weald_walker, ahmvodinp",
            "ars_nouveau:whelp, ahmvodinp",
            "cavesandcliffs:axolotl, ahmvodinp",
            "cavesandcliffs:glow_squid, ahmvodinp",
            "cavesandcliffs:goat, ahmvodinp",
            "charm:coral_squid, ahmvodinp",
            "charm:moobloom, ahmvodinp",
            "endergetic:bolloom_balloon, ahmvodinp",
            "endergetic:booflo, ahmvodinp",
            "endergetic:booflo_adolescent, ahmvodinp",
            "endergetic:booflo_baby, ahmvodinp",
            "endermail:ender_mailman, ahmvodinp",
            "farmingforblockheads:merchant, ahmvodinp",
            ...
            "iceandfire:hippocampus, ahmvodinp",
            ...
            "inventorypets:anvil_pet_entity, ahmvodinp",
            "inventorypets:bed_pet_entity, ahmvodinp",
            "inventorypets:bill_gates_entity, ahmvodinp",
            "inventorypets:mini_quantum_blaze_entity, ahmvodinp",
            "inventorypets:mini_quantum_enderman_entity, ahmvodinp",
            "inventorypets:satya_nadella_entity, ahmvodinp",
            "inventorypets:siamese_entity, ahmvodinp",
            "inventorypets:steve_ballmer_entity, ahmvodinp",
            "losttrinkets:dark_vex, ahmvodinp",
            "iceandfire:myrmex_swarmer, ahmvodinp",
            "meetyourfight:bellringer, ahmvodinp",
            "meetyourfight:dame_fortuna, ahmvodinp",
            "meetyourfight:swampjaw, ahmvodinp",
            "minecraft:bat, ahmvodinp",
            "minecraft:bee, ahmvodinp",
            "minecraft:chicken, ahmvodinp",
            "minecraft:cod, ahmvodinp",
            "minecraft:cow, ahmvodinp",
            "minecraft:dolphin, ahmvodinp",
            "minecraft:donkey, ahmvodinp",
            "minecraft:fox, ahmvodinp",
            "minecraft:horse, ahmvodinp",
            "minecraft:llama, ahmvodinp",
            "minecraft:mooshroom, ahmvodinp",
            "minecraft:mule, ahmvodinp",
            "minecraft:ocelot, ahmvodinp",
            "minecraft:panda, ahmvodinp",
            "minecraft:parrot, ahmvodinp",
            "minecraft:phantom, nwaq",
            "minecraft:pig, ahmvodinp",
            ...
            "minecraft:polar_bear, ahmvodinp",
            "minecraft:pufferfish, ahmvodinp",
            "minecraft:rabbit, ahmvodinp",
            "minecraft:salmon, ahmvodinp",
            "minecraft:sheep, ahmvodinp",
            ...
            "minecraft:squid, ahmvodinp",
            "minecraft:stray, sw",
            "minecraft:strider, ahmvodinp",
            "minecraft:trader_llama, ahmvodinp",
            "minecraft:tropical_fish, ahmvodinp",
            "minecraft:turtle, ahmvodinp",
            "minecraft:vex, ahmvodinp",
            "minecraft:villager, ahmvodinp",
            ...
            "minecraft:zoglin, l",
            "minecraft:zombie, s",
            "minecraft:zombie_horse, ahmvodinp",
            ...
            "mod_lavacow:weta, c",
            "mowziesmobs:barako, ahmvodinp",
            "mowziesmobs:barakoan_player, ahmvodinp",
            "mowziesmobs:ferrous_wroughtnaut, ahmvodinp",
            "mowziesmobs:foliaath, a",
            "mowziesmobs:frostmaw, s",
            "mowziesmobs:grottol, navw",
            "mowziesmobs:lantern, ahmvodinp",
            "mowziesmobs:naga, m",
            "mutantbeasts:creeper_minion, ahmvodinp",
            "mutantbeasts:endersoul_clone, ahmvodinp",
            "mutantbeasts:mutant_enderman, napw",
            "mutantbeasts:mutant_skeleton, semw",
            "mutantbeasts:mutant_snow_golem, ahmvodinp",
            "mutantbeasts:mutant_zombie, sw",
            "mutantbeasts:spider_pig, ahmvodinp",
            ...
            "mutantmore:rodling, ahmvodinp",
            "mysticalworld:beetle, ahmvodinp",
            "mysticalworld:deer, ahmvodinp",
            "mysticalworld:endermini, naw",
            "mysticalworld:frog, ahmvodinp",
            "mysticalworld:hell_sprout, ahmvodinp",
            "mysticalworld:lava_cat, ahmvodinp",
            "mysticalworld:owl, ahmvodinp",
            "mysticalworld:silkworm, ahmvodinp",
            "mysticalworld:silver_fox, ahmvodinp",
            "mysticalworld:sprout, ahmvodinp",
            "outer_end:chorus_squid, ahmvodinp",
            "outer_end:entombed, w",
            "outer_end:purpur_golem, w",
            "outer_end:spectrafly, ahmvodinp",
            "outer_end:stalker, nap",
            "quark:crab, ahmvodinp",
            "quark:forgotten, semw",
            "quark:foxhound, p",
            "quark:frog, ahmvodinp",
            "quark:shiba, ahmvodinp",
            "quark:stoneling, ep",
            "quark:toretoise, n",
            "quark:wraith, heq",
            "quark:wrapped, s",
            ...
            "switchbow:entitylittleirongolem, ahmvodinp",
            "thermal:basalz, p",
            "thermal:blitz, p",
            "thermal:blizz, p",
            "twilightforest:lich_minion, ahmvodinp",
