...
public class StealthTags {
    ...
    public static final TagKey<EntityType<?>> NEVER_LOOK = makeKey("never_look");
    ...
    private static TagKey<EntityType<?>> makeKey(String path) {
        return TagKey.create(Registries.ENTITY_TYPE, new ResourceLocation(CloakAndDagger.MODID, path));
    }
